  ...
  return (
    <div className="bg-gray-800 text-white rounded-lg shadow-lg p-6">
      ...
      <div className="grid grid-cols-3 gap-4 text-center text-sm">
        <div className="text-2xl font-bold bg-gray-700 py-1 rounded flex items-center justify-center">
        ...
        <div className="text-2xl font-bold bg-gray-600 py-1 rounded flex items-center justify-center">
